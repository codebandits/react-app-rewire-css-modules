...
module.exports = function (config, env) {
    ...
    addAfterRule(sassRule, postcssLoaderMatcher, { loader:require.resolve('sass-loader'), options: { includePaths: ['node_modules'] }})
    ...
    addAfterRule(sassModulesRule, postcssLoaderMatcher, { loader:require.resolve('sass-loader'), options: { includePaths: ['node_modules'] }})
